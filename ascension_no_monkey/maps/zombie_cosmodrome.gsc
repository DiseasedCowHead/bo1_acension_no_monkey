...
//	level.monkey_zombie_failsafe = maps\zombie_cosmodrome_ai_monkey::monkey_cosmodrome_failsafe;
	...
	// level.next_dog_round = 2; Used for debugging, forces the dog round to happen at round 2
...
on_player_spawned()
{
	...
	// get_players()[0] IPrintLnBold( "(Test) Next dog round: " + level.next_dog_round ); Debug print
	get_players()[0] IPrintLnBold( "Acension No Monkey" );
}
